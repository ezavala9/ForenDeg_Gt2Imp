...
#if os.path.exists(vcf_file2): # read in "correct" genotypes from reference VCF in SNP_Panels/ for that individual into a dictionary
    #print("reading in correct genotypes")
...
def count_concordant_genotypes(vcf_file1, vcf_dict_bases, vcf_dict_gts, individual): #Checks if called genotypes match "correct" genotypes
    ...
    cGTs_2alt2alt=0
    dGTs_2alt2alt=0
    with gzip.open(vcf_file1,'rt') as simfile:
        ...
        for line in simfile:
            if line.startswith("#"):
                ...
                if gt1 !="." and gt2 !=".":
                    ...
                    genotype_bases=[gt_base1, gt_base2]
                    poscols=line.strip().split("\t")[7].split(";")
